...
ARG QSign_VERSION="1.1.8"
ARG QQ_VERSION="8.9.63"

RUN apk add --no-cache --update \
        		ca-certificates &&  \
    wget https://github.com/fuqiuluo/unidbg-fetch-qsign/releases/download/$QSign_VERSION/unidbg-fetch-qsign-shadow-${QSign_VERSION}.zip && \
    ...
    unzip -q ./unidbg-fetch-qsign-shadow-${QSign_VERSION}.zip && \
    mv ./unidbg-fetch-qsign-shadow-${QSign_VERSION}/* "/resource/qsign/" && \
